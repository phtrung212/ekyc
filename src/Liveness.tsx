...
const detections = {
  BLINK: { instruction: "Chớp mắt", minProbability: 0.3 },
  TURN_HEAD_LEFT: { instruction: "Xoay đầu qua trái", maxAngle: -15 },
  TURN_HEAD_RIGHT: { instruction: "Xoay đầu qua phải", minAngle: 15 },
  NOD: { instruction: "Gật đầu", minDiff: 1.5 },
  SMILE: { instruction: "Cười", minProbability: 0.7 }
}
